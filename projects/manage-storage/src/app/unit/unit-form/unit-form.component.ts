...
export class UnitFormComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.http.get<Array<CategoryDTO>>(`/api/admin/categories`).subscribe(data => {
      console.log(data)
  ...
  fetchSubcategory(categoryId: string) {
    this.http.get<Array<SubcategoryDTO>>(`/api/admin/subcategories`, {params : {
  ...
  fetchItem(subcategoryId: string) {
    this.http.get<Array<ItemDTO>>(`/api/admin/items`, {params : {
  ...
  fetchUnit(itemId: string) {
    this.http.get<Array<UnitDTO>>(`/api/admin/units`, {params : {
      "itemId": itemId
    }}).subscribe(data => {
      console.log(data)
      this.units = data;
